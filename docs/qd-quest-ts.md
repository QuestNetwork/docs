...
qD Quests offers the ability to share and join quests shared by peers on the network. qD Quests is connected to [qDesk Social](qd-social-js) and uses the station supplied by qDesk Social. qDesk Quest and qDesk Social are modules for [qDesk](qDesk) and it's built on [Quest OS](quest-os-js) which makes use of the [Interplanetary Filesystem](https://ipfs.io), [IPFS GossipSub](https://blog.ipfs.io/2020-05-20-gossipsub-v1.1/), [IPFS DAGs](https://docs.ipfs.io/concepts/merkle-dag/), and [qDesk](qDesk), our example app based on [Angular10](https://angular.io/).
