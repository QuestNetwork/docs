![Completion 1.0.0](https://img.shields.io/badge/completion%20v1.0.0-1%25-red) ![Help Wanted](https://img.shields.io/badge/%20-help--wanted-%23159818)  ![Version 0.9.3](https://img.shields.io/badge/version-v0.9.5-blue) ![Sponsors](https://img.shields.io/badge/sponsors-0-red)

# qDesk Video

# Description

qDesk Video is a module for qDesk. It's accessible across qDesk, you can use it with qDesk Social, qDesk Messages and other qDesk modules.

qDesk Video offers the ability to share videos and explore videos shared by peers on the network. qDesk Video is connected to qDesk Social and uses the station supplied by qDesk Social.
